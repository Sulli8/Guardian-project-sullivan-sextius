...
Run `npm build` to build the project. The build artifacts will be stored in the `dist/guardian-project-sullivan-sextius` directory. Use the `--prod` flag for a production build.
